...
This repository includes programs that we worked on in the course "IT Security" at the University of Applied Sciences in Berlin.
It includes the following projects:

- Automated Solver for Simple Substitution Ciphers
